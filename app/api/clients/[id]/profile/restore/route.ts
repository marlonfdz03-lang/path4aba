...
//
// Ownership-gated exactly like the refresh (RBT of the client, or a connected BCBA). One level only: the
// snapshot was stored WITHOUT its own previousProfile, so restoring clears the undo slot — no redo, no
// compounding.
