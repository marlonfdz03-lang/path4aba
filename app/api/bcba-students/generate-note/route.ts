...
const ACTIVITY_TYPE_INSTRUCTIONS: Record<string, string> = {
  restricted: `\n\nACTIVITY TYPE: RESTRICTED — DIRECT CLIENT CONTACT\nThis note must reflect direct observation, data collection, or hands-on implementation during client contact.\n\nREQUIRED language: direct observation, implemented, administered, collected data, delivered, prompted, reinforced, recorded, client responding, session participation, direct assessment administration.\n\nSTRICTLY FORBIDDEN — never use these phrases: treatment planning, programming decisions, intervention outcomes, treatment modifications, behavioral trends and variability, evaluate treatment effectiveness, support treatment decisions, inform treatment decisions, ongoing client programming.\n\nThe note must sound like the writer was physically present with the client doing direct work — not analyzing or planning.`,
  unrestricted: `\n\nACTIVITY TYPE: UNRESTRICTED — BCBA-LEVEL ANALYTICAL WORK\nThis note must reflect analytical, planning, or review activities away from direct client implementation.\n\nREQUIRED language: reviewed, analyzed, evaluated, visual analysis, behavioral trends, variability, treatment outcomes, programming decisions, treatment effectiveness, intervention modifications, data-based decisions.\n\nSTRICTLY FORBIDDEN — never use these phrases: implemented procedures, delivered, prompted, administered to client, direct observation of client, collected real-time data during session, conducted procedures with client.\n\nThe note must sound like the writer was analyzing data and making clinical decisions — not implementing directly with a client.`,
}
